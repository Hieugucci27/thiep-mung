const nameGirl = 'Hdh ❤ Hha;
const giftUrl = 'http://nodemy.vn';
const eventName = 'Chúc mừng Valentine';
const titleCard = 'Tặng';
const contentCard = 'Chúc Vợ Của anh 14/2 tràn ngập niềm vui và những nụ cười. Mong Em Mãi Bên Cả SAu Này Lẫn Bây Giờ';
